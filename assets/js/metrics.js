function MetricsCtrl($scope, $http, $routeParams, $log, $sce, expvar) {
  $scope.active = true;
  ...
  function monitorIndex(name) {
    ...
    idx = {
      metrics: [
        ...
        name: name+"updates",
        display: "Updates",
        path: "/metrics/indexes/" + name  + "/index/updates",
        type: "rate",
        color: "steelblue",
      ...
      },
      {
        name: name+"deletes",
        display: "Deletes",
        path: "/metrics/indexes/"+ name  +"/index/deletes",
        type: "rate",
        color: "steelblue",
        yaxis: Rickshaw.Fixtures.Number.formatKMBT,
        xformatter: isoDateFormatter,
      ...
      },
      {
        ...
        series: [
          ...
          display: "Index",
          name: name+"indextime",
          path: "/metrics/indexes/"+ name  +"/index/index_time",
          type: "rate",
          color: "red",
        },
        {
          ...
          path: "/metrics/indexes/" + name  + "/index/analysis_time",
          type: "rate",
          color: "green",
        }
        ],
      ...
      },
      {
        name: name+"searches",
        display: "Searches",
        path: "/metrics/indexes/"+ name  +"/searches",
        type: "rate",
        color: "steelblue",
        yaxis: Rickshaw.Fixtures.Number.formatKMBT,
        xformatter: isoDateFormatter,
      ...
      },
      {
        ...
        display: "Search Time",
        path: "/metrics/indexes/"+ name  +"/search_time",
        type: "rate",
        color: "steelblue",
        yaxis: Rickshaw.Fixtures.Number.formatKMBT,
        xformatter: isoDateFormatter,
  ...
  expvar.addKeysLookup("indexes", "/metrics/indexes");
